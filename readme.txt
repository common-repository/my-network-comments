...
== Description ==
WordPress [Multisite](http://codex.wordpress.org/Create_A_Network) network plugin to add "My Network Comments" page to the Dashboard. Tracks all comments made by a network user on any blog in the network.
